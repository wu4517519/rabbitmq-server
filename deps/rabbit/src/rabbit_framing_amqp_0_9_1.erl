...
-type amqp_method_name() ::
       ...
       | 'basic.recover_ok' | 'basic.nack' | 'connection.start' | 'connection.start_ok'
       | 'connection.secure' | 'connection.secure_ok' | 'connection.tune' | 'connection.tune_ok'
       | 'connection.open' | 'connection.open_ok' | 'connection.close' | 'connection.close_ok'
       | 'connection.blocked' | 'connection.unblocked' | 'connection.update_secret' | 'connection.update_secret_ok'
...
-type amqp_method() ::
       ...
       | {90, 20} | {90, 21} | {90, 30} | {90, 31} | {85, 10} | {85, 11} ).
...
-type amqp_method_field_name() ::
       ...
       | challenge | channel_id | channel_max | class_id
       | client_properties | cluster_id | consumer_count | consumer_tag
       | delivery_tag | destination | durable | exchange
